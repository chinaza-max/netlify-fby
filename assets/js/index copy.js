            ...
            for(let i=0; i<data.data.length;i++){
              ...
              /*
                ...
                $("#modalContainer").append(
                  ` <div class="modal fade" id="modalPending_${data[i].job_id}" tabindex="-1" role="dialog" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <main class="main-content mb-0">
                          ...
                          <div class="main-content-wrap">
                            ...
                            <header class="page-header" style="clear: right;">
                              <h1 class="page-title"  style="clear: both;">${data[i].facility_name}</h1>
                            </header>
                              ...
                              <div class="card">
                                ...
                                <div class="card-body">
                                  <div class="table-responsive">
                                    <table class="table table-bordered table-sm">
                                      ...
                                      <tbody id="pendingscheduleTable${data[i].job_id}">
                                ...
                                <div class="card-body">
                                  <div class="alert alert-light outline text-dark" role="alert">
                                    Job type:<strong> ${data[i].job_type}</strong>
                                  </div>
                      ...
                      <div class="modal-footer">
                        <div class="actions">
                          ...
                          <button type="button" class="btn btn-primary" onclick="acceptDecline( ${data[i].job_id},true)" >Accept </button>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              if( data.data[i].status=="PENDING"){
                for(let j=0; j<data.data[i].schedule.length;j++){
                  ...
                  $(`#pendingscheduleTable${data.data[i].id}`).append(
                      ` 
                      <tr>
                          <td> ${data.schedule[j].check_in_date}</td>
                          <td>${data.schedule[j].start_time}</td>
                          <td>${data.schedule[j].end_time}</td>
                      </tr>
                      `
                  );
              }
